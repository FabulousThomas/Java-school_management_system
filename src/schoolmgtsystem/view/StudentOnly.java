 ...
 * @author FabulousTHO
 */
public class StudentOnly extends javax.swing.JFrame {
...
//    String conStr = "jdbc:sqlserver://localhost;instanceName=SQLEXPRESS;databaseName=Home;user=sa;password=123456789";
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Student Profile Access");
        jPanel3.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 130, 270, -1));
    ...
    private void ThomMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ThomMouseClicked
        String j = Student.txtFirstName.getText();
        ...
        try {
            ...
            StudentProfileOnly sp = new StudentProfileOnly();
                ...
                while (rs.next()) {
                    if (j.equals(rs.getString("FirstName"))) {
                        ...
                        JOptionPane.showMessageDialog(sp, "Access denied \n You are not Thomas Eric");
            ...
            Logger.getLogger(StudentOnly.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void FabMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_FabMouseClicked
        String a = Student.txtFirstName.getText();
    ...
    private void DanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_DanMouseClicked
        String b = Student.txtFirstName.getText();
        
        String str = "Select FirstName, Surname,Username, StudentID, CourseCode, Email, State, Phone from PrincipalView where Email = 'danielscott@gmail.com'";
    ...
    private void WillMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_WillMouseClicked
        String c = Student.txtFirstName.getText();
        
        String str = "Select FirstName, Surname,Username, StudentID, CourseCode, Email, State, Phone from PrincipalView where Email = 'williamswells@gmail.com'";
    ...
    private void LydMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_LydMouseClicked
        String d = Student.txtFirstName.getText();
    ...
    private void AdamsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AdamsMouseClicked
        String f = Student.txtFirstName.getText();
        
        String str = "Select FirstName, Surname,Username, StudentID, CourseCode, Email, State, Phone from PrincipalView where Email = 'adamsrechard@gmail.com'";
    ...
    private void VivMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_VivMouseClicked
        String g = Student.txtFirstName.getText();
    ...
    private void DapMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_DapMouseClicked
        String h = Student.txtFirstName.getText();
        
        String str = "Select FirstName, Surname,Username, StudentID, CourseCode, Email, State, Phone from PrincipalView where Email = 'daphnefelix@gmail.com'";
    ...
    private void KelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_KelMouseClicked
        String i = Student.txtFirstName.getText();
        
        String str = "Select FirstName, Surname,Username, StudentID, CourseCode, Email, State, Phone from PrincipalView where Email = 'kelvinchris@gmail.com'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentOnly.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StudentOnly().setVisible(true);
            }
        });
    }
