 ...
 * @author FabulousTHO
 */
public class StaffProfileOnly extends javax.swing.JFrame {

    /**
     * Creates new form TeachersProfileOnly
     */
    public StaffProfileOnly() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, 720, 10));
        ...
        jPanel1.add(jSeparator9, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 570, 170, 10));
        ...
        jPanel1.add(lblClick, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 550, -1, 20));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StaffProfileOnly.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StaffProfileOnly().setVisible(true);
            }
        });
    }
